...
| `sessionTimeout` | `3600` | Idle MCP session timeout in seconds (60 min) |
...
| `jwtSecret` | — | **Required when users are defined.** Secret for signing JWT tokens (min 32 chars) |
...
users:
  alice:
    ...
    passwordHash: "$scrypt$65536$8$1$salt$hash"   # generated by: graphmemory users add
