...
export const TOOL_CATALOG: Record<string, ToolInfo> = {
  ...
  tasks_create_link: { graph: 'tasks', description: 'Link a task to a node in another graph (code symbol, doc section, file, note, skill)' },
  tasks_delete_link: { graph: 'tasks', description: 'Remove a cross-graph link from a task' },
  ...
  skills_create_link: { graph: 'skills', description: 'Link a skill to a node in another graph (code, docs, files, knowledge, tasks)' },
  skills_delete_link: { graph: 'skills', description: 'Remove a cross-graph link from a skill' },
