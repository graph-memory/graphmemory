...
description: "Graph Memory v1.3 — an MCP server that turns your project into a queryable semantic knowledge base with 58 AI tools."
---
...
These graphs are interconnected. A note can link to a code symbol. A task can reference a doc section. A skill can point to the files it modifies. Your AI assistant navigates these connections through **58 MCP tools**.
